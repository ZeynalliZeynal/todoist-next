      ...
      <button
        ...
        className={`font-medium border select-none ${
          primary
            ...
            : "text-background-100 border-gray-200 bg-gray-1000 hover:bg-button-bg-hover disabled:bg-button-bg-disabled disabled:text-gray-700 disabled:border-gray-400"
        } ${size === "md" ? "px-2.5 h-10 text-sm" : size === "lg" ? "px-3.5 h-12" : "text-sm h-8 px-1.5"} ${full ? "w-full" : "w-fit"} rounded-${rounded}`}
        onClick={onClick}
        disabled={disabled}
      >
